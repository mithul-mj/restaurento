...
import userReviewRoutes from "./user/userReview.routes.js";
...
router.use("/api/v1/auth/", authLimiter, commonAuthRoutes);
...
router.use("/api/v1/admin", authLimiter, adminAuthRoutes);

router.use("/api/v1/restaurant", authLimiter, restaurantAuthRoutes);

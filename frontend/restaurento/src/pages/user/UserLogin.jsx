    ...
    return (
        ...
        >
            ...
            <p className="text-center mt-8 text-sm text-gray-300 md:text-gray-500">
                Don't have an account? <Link to="/signup" className="text-[#ff5e00] font-semibold hover:underline">Register Now</Link>
            </p>
            <p className="text-center mt-4 text-xs text-gray-300 md:text-gray-400">
                Are you a restaurant? <Link to="/restaurant/login" className="text-[#ff5e00] hover:underline">Login here</Link>
            </p>
        </AuthLayout>
    );
};

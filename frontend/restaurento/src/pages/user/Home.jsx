...
const Home = () => {
  const { user, role, avatar } = useSelector((state) => state.auth);
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-6">
        ...
        <div className="w-full max-w-4xl mx-auto -mt-14 relative z-10 mb-10 px-2">
          <form
            ...
            className="relative flex shadow-xl shadow-gray-200/50 rounded-lg overflow-hidden">
            ...
            <button
              type="submit"
              className="bg-[#ff9500] hover:bg-[#e08400] text-white px-8 font-semibold transition-colors flex items-center gap-2">
              <Search size={18} />
          ...
          {restaurants.map((item) => (
            <div
              ...
              <div className="relative h-48 w-full overflow-hidden">
                ...
                />
                <div
                  className={`absolute top-4 right-4 ${item.statusColor} text-white text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wide`}>
                  {item.status}
                </div>
              </div>
        ...
        <div className="flex justify-center items-center gap-2 mt-8">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded-full bg-[#ff5e00] text-white shadow-md shadow-orange-200">
            1
          </button>
          <button className="w-8 h-8 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 hover:text-[#ff5e00] hover:border-[#ff5e00] transition-colors">
            2
          </button>
          <button className="hidden md:flex w-8 h-8 items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 hover:text-[#ff5e00] hover:border-[#ff5e00] transition-colors">
            3
          </button>
